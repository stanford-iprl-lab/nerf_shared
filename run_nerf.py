...
####################### EXECUTING MAIN LOOP ##########################################
        ...
        #P0 = torch.eye(4)
        P0 = torch.tensor([[0.8553642379820887, -0.23166880341376, 0.4633374428061661, 0.5180270093731302], [4.578144069931667e-08, 0.8944271614812368, 0.4472136545373088, 0.5], [-0.518027045994047, -0.38253054561623456, 0.7650610180170123, 0.8553642601605066], [0.0, 0.0, 0.0, 1.0]])
        PT = torch.eye(4)
        T = 5
        N = 5
        N_iter = 300
